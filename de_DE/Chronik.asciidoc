...
Ein wichtiger Teil in einer Software ist die Chronik, dies ist ein richtiges Gedächtnis.  Es ist in DomoPro möglich
...
dann wird DomoPro versuchen, den Wert alle die 5 Minuten für die chronik wieder zu erlangen. 
...
Par défaut DomoPro archive les données plus veilles de 2 heures par paquet de 1 heure.
