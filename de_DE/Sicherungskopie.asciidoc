...
Hier werden ihre DomoPro Backups verwalten. Mehrere Optionen sind verfügbar.
...
Der zweite Abschnitt ermöglicht es Ihnen, lokale Backups zu verwalten (in DomoPro). Sie können eine Sicherung auswählen und dann wiederherstellen, löschen oder laden Sie es auf Ihren Computer.
