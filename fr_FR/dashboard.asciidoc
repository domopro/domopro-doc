...
Une des pages principale de DomoPro celle-ci affiche un compte rendu de toute votre domotique. Ce compte-rendu (contrairement aux vues et design) est auto-generé par DomoPro.
...
[TIP]
Il est possible à partir de votre profils de configurer DomoPro pour que l'arbre des objets et/ou les scénarios soit visible par defaut lorsque vous arrivez sur le Dashboard
