...
Sur cette page vous retrouvez tous les plugins présent sur votre DomoPro. Ceux en rouge sont ceux qui sont désactivés. En cliquant sur un plugin vous accèdez à sa configuration : 
...
* *Supprimer* : Supprime le plugin de votre DomoPro. Attention cela supprime définitivement tous les équipements de ce plugin aussi
...
[IMPORTANT]
Il n'est vraiment pas recommandé de mettre un plugin beta sur un DomoPro beta, beaucoup de soucis de fonctionnement peuvent en resulter
