...
L'accès à l'API se fait par l'url : #URL_domopro#/core/api/jeeApi.php
...
=== jeeNetwork::halt
Permet d'arreter domopro

=== jeeNetwork::reboot
Permet de redemarrer domopro
...
=== update::update
Permet de mettre à jour domopro et tous les plugins

== API JSON Exemples
Voici un exemple d'utilisation de l'API. Pour l'exemple si dessous j'utilise https://github.com/domopro/core/blob/stable/core/class/jsonrpcClient.class.php[cette class php] qui permet de simplifier l'utilisation de l'api.

Récupération de la liste des objets :


[source,php]
$jsonrpc = new jsonrpcClient('#URL_domopro#/core/api/jeeApi.php', #API_KEY#);
